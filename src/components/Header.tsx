...
export default function Header() {
  ...
  const goCopertura = (e: React.MouseEvent) => {
    e.preventDefault();
    closeMenu();
    navigate('/copertura');
  };
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="header-inner">
            ...
            <nav className="nav">
              ...
              <a href="/copertura" onClick={goCopertura} className="nav-copertura">
                Verifica Copertura
              </a>
            </nav>

            <div className="header-actions">
              <a href="tel:+3901411745884" className="header-phone">
                <Phone size={15} />
                +39 0141 1745884
              </a>
      ...
      <div className={`mobile-menu${menuOpen ? ' open' : ''}`}>
        ...
        <a href="/copertura" onClick={goCopertura}>Verifica Copertura</a>
        <a href="tel:+3901411745884" className="mobile-menu-phone">
          <Phone size={16} />
          +39 0141 1745884
        </a>
      </div>
