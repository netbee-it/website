...
const WHATSAPP_NUMBER = '3901411745884';
const WHATSAPP_MESSAGE = "Ciao NetBee, vorrei avere informazioni sui vostri servizi internet.";
      ...
      {open && (
        <div className="wa-popup">
          ...
          <div className="wa-popup-header">
            ...
            <div>
              <div className="wa-popup-name">NetBee Assistenza</div>
              <div className="wa-popup-status">
                <span className="wa-popup-dot" /> Online ora
              </div>
            </div>
          </div>
          <div className="wa-popup-body">
            <div className="wa-popup-message">
              ...
              <br />
              Scrivici su WhatsApp per informazioni su piani, copertura e attivazione.
            </div>
          </div>
          <a
            href={waLink}
